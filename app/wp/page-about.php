            ...
            <div class="row no-gutters">
                <div class="col-12">
                    ...
                    <?php if ($ums_about_video_bg): ?>
                        <button type="button" data-video-id="<?php echo $ums_about_video_id; ?>" style="background-image: url(<?php echo $ums_about_video_bg; ?>);" class="modal-video-button about-page__video">
