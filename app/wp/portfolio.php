...
<section class="section portfolio">
        ...
        <footer class="section__footer portfolio__footer">
            ...
            <a href="https://www.behance.net/ux_mind_school/" target="_blank" class="icon icon-external-link link portfolio__footer-link">Работы наших учеников на Behance</a>
        </footer>
        <?php endif; ?>
    </section>
<?php endif; ?>