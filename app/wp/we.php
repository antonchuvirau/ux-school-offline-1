                        ...
                        <div class="we__carousel swiper-container">
                            <div class="swiper-wrapper we__carousel-wrapper">
                                ...
                                <div class="swiper-slide we-item we__slide">
                                    ...
                                    <p class="we-item__desc">Преподаватели дают обратную связь и отвечают на вопросы даже вне лекций</p>
                                </div>
                                <div class="swiper-slide we-item we__slide">
                                ...
                                <div class="swiper-slide we-item we__slide">
                                    ...
                                    <p class="we-item__desc">Мы подготовили полезности, которые наши студенты получат не только на курсах, но и после них</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-pagination we__pagination swiper-pagination-bullets"></div>
